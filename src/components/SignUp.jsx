        ...
        <div className="flex items-center justify-center h-screen">
            <div className="flex flex-col items-center font-poppins">
                <div className="space-y-7 flex items-center flex-col w-full">
                    <div className="mt-12 w-20 bg-[#D6DFFF] rounded-3xl p-2">
                    ...
                    <div className="space-y-4 w-full">
                        <div className="mb-8 flex flex-col gap-4">
                            <div className="w-full">
                                <input type="text" placeholder="solaiman57544@gmail.com" className="input bg-[#F5F9FE] w-full p-5 placeholder-[#262626]" />
                            </div>
                            <div className="w-full space-y-2">
                                <label className="input flex items-center gap-2 bg-[#F5F9FE]">
